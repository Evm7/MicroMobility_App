...
public abstract class CameraVideoFragment extends BaseFragment {
    ...
    // Used to handle the hierachy of the videos
    ...
    private File getOutputMediaFile() {
        ...
        String video_name = "VID_" + timeStamp + ".mp4";

        // External sdcard file location --> MICROMOBILITY/username/video_title
        String video_directory = GENERAL_DIRECTORY_NAME+File.separator+this.username+File.separator+video_name;
        File mediaStorageDir = context.getExternalFilesDir(video_directory);
        // Create storage directory if it does not exist
        ...
        mediaFile = new File(mediaStorageDir.getPath() +File.separator + video_name);
        return mediaFile;
    }
    ...
    public void startRecordingVideo(Context context, String username) {
